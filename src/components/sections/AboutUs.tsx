        ...
        <div className="flex flex-col lg:flex-row items-center gap-16">
          <div className="flex-1">
            <div className="relative">
              ...
              <div className="absolute -bottom-8 -right-8 bg-white p-8 rounded-2xl shadow-xl z-20 hidden md:block">
                ...
                <p className="text-sm font-bold text-primary uppercase tracking-wider">Years of Reliability</p>
              </div>
            </div>
          </div>
          ...
          <div className="flex-1">
            ...
            <p className="text-lg text-muted-foreground mb-8">
              We serve as an "anchor team" for founders who need to focus on their product while we handle 
              the technical complexity of hosting, deployments, and ongoing maintenance.
            </p>
