    ...
    <section className="relative pt-24 pb-16 lg:pt-32 lg:pb-24 overflow-hidden bg-primary text-white">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-sm lg:text-base text-blue-100/70 mb-8 max-w-xl mx-auto leading-relaxed animate-fade-up animate-delay-200 font-medium">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center items-center animate-fade-up animate-delay-300">
            ...
            <Button size="sm" variant="outline" asChild className="border-white/30 text-white hover:bg-white/10 h-10 px-6 font-bold rounded-lg text-sm transition-all bg-transparent">
          ...
          <div className="mt-16 grid grid-cols-1 sm:grid-cols-3 gap-4 text-left animate-fade-up animate-delay-300">
            {[
              ...
              <div key={i} className="p-5 rounded-[1.25rem] bg-white/5 border border-white/10 backdrop-blur-xl hover:bg-white/10 transition-all group shadow-xl">
                <h3 className="font-bold text-white text-base mb-1.5">{feature.title}</h3>
                <p className="text-[11px] text-blue-100/50 leading-relaxed font-medium">{feature.desc}</p>
              </div>
            ))}
          </div>
        </div>
